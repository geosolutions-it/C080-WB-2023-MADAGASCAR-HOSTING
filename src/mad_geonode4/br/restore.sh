...
echo "-----------------------------------------------------"
echo "STARTING mad_geonode4 RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./mad_geonode4/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED mad_geonode4 RESTORE $(date)"
echo "-----------------------------------------------------"
